...
export const pagesContent = {
  home: {
    metadata: {
      title: 'Playful directory discovery for listings and local posts',
      description: 'Browse listings, classified posts, stories, and helpful resources through a warm directory-style homepage.',
      openGraphTitle: 'Playful directory discovery for listings and local posts',
      openGraphDescription: 'Discover listings, posts, and local resources through a warm, playful directory-style experience.',
      keywords: ['classified listings', 'directory site', 'local discovery', 'community posts'],
    },
    hero: {
      badge: 'Smart local discovery',
      title: ['Find the right listing, story,', 'or opportunity in one place.'],
      description: 'Search through fresh classifieds, useful listings, and community-ready posts with a layout that feels friendly, clear, and fast.',
      primaryCta: { label: 'Start browsing', href: '/classified' },
      secondaryCta: { label: 'See listings', href: '/listing' },
      searchPlaceholder: 'Search listings, services, ideas, and more',
      focusLabel: 'Directory',
      featureCardBadge: 'fresh finds',
      featureCardTitle: 'Live posts power the homepage highlights.',
      featureCardDescription: 'Recent content stays visible across the hero, discovery cards, and spotlight sections without changing any backend behavior.',
    },
    intro: {
    ...
    cta: {
      badge: 'Join the flow',
      title: 'Post something useful, browse something new, and keep the conversation moving.',
      description: 'From quick listings to deeper reads, every section stays connected so visitors can discover more without friction.',
