...
import { EditableHomeCta, EditableHomeHero, EditableMagazineSplit, EditableTimeCollections, HomePostShowcase } from '@/editable/sections/HomeSections'
...
export default async function HomePage() {
  ...
  <Ads slot="header" showLabel eager className="mx-auto w-full" />
      ...
      <HomePostShowcase primaryTask={primaryTask} primaryRoute={primaryRoute} posts={primaryPosts} timeSections={timeSections} />
