...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-current/10 bg-white/80 p-8 text-center shadow-[0_18px_40px_rgba(49,54,35,0.08)]', className)}>
      ...
      <Link href={actionHref} className="mt-6 inline-flex items-center gap-2 rounded-full border border-current/15 px-5 py-3 text-sm font-semibold transition hover:-translate-y-0.5 hover:bg-current hover:text-background">
        {actionLabel}
