export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'lusentry',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Lusentry',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'lusentry.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://lusentry.com',
